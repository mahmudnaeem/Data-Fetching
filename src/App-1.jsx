      ...
      <div className="content">
        {
          searchTerm.length > 0 && searching ? (
            ...
            //     onReset={() => {<AllCharsRender characters={characters} setCharacters={setCharacters} />}}>
                ...
                <FilteredRender searching={searching} setSearching={setSearching} searchTerm={searchTerm} setSearchTerm={searchTerm} characters={characters} setCharacters={setCharacters}  searchKey={searchKey} />
